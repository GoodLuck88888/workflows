...
PyPI integration, can be found in the [xw_cbase]_  repository.

.. [xw_cbase] https://github.com/pybind/xw_cbase
...
can refer to the same [xw_cbase]_ repository for a full sample project
